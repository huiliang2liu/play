...
public class Device implements org.cybergarage.http.HTTPRequestListener,
    ...
    public String getAbsoluteURL(String urlString, String baseURLStr,
        ...
        Log.e(TAG, String.format("urlString:%s,baseURLStr:%s,locationURLStr:%s", urlString, baseURLStr, locationURLStr));
        ...
        if ((baseURLStr != null) && (0 < baseURLStr.length())) {
            ...
            if (baseURLStr.endsWith("/")) {
                if (urlString.startsWith("/")) {
                    absUrl = baseURLStr + urlString.substring(1);
                } else {
            ...
            absUrl = HTTP.getAbsoluteURL(baseURLStr, urlString);
            try {
                URL url = new URL(absUrl);
                return url.toString();
            } catch (Exception e) {

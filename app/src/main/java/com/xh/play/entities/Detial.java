...
public class Detial implements Parcelable {
    public static final Parcelable.Creator<Detial> CREATOR
            = new Parcelable.Creator<Detial>() {
    ...
    public static class DetailPlayUrl implements Parcelable {
        ...
        public static final Parcelable.Creator<DetailPlayUrl> CREATOR
                = new Parcelable.Creator<DetailPlayUrl>() {
